...
def extract_schema_metadata(db_path="schemapilot.duckdb", output_path="schema_config.yaml"):
    ...
    for table_name, table_type in tables:
        ...
        for col_name, data_type, is_nullable in columns:
            try:
                ...
                # Convert Decimals or special types to standard python floats/ints/strings
                samples = []
...
if __name__ == "__main__":
    extract_metadata.py() if "extract_metadata.py" == "" else extract_schema_metadata()
